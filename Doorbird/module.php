<?
    ...
    private function RegisterMedia() {
		...
		private function RegisterNotifications() {
			...
			IPS_LogMessage("Doorbird","notification.cgi?url=http://".$_SERVER["HTTP_HOST"]."/hook/doorbird-doorbell&user=&password=&event=doorbell&subscribe=1&relaxation=10");
			...
			$this->GetData("notification.cgi?url=http://".$_SERVER["HTTP_HOST"]."/hook/doorbird-motionsensor&user=&password=&event=motionsensor&subscribe=1&relaxation=10");
