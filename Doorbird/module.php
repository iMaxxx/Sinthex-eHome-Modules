<?
    ...
    private function RegisterMedia() {
		...
		private function RegisterNotifications() {
			...
			$this->GetData("notification.cgi?url=http://".getenv('SERVER_ADDR').":".getenv('SERVER_PORT')."/hook/doorbird-doorbell&user=&password=&event=doorbell&subscribe=1&relaxation=10");
			...
			$this->GetData("notification.cgi?url=http://".getenv('SERVER_ADDR').":".getenv('SERVER_PORT')."/hook/doorbird-motionsensor&user=&password=&event=motionsensor&subscribe=1&relaxation=10");
