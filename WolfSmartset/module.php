    ...
    class WolfSmartset extends IPSModule {
        ...
        */
		...
		public function GetValues() {
			...
			$post_parameters = (object) array("GuiId"=>1000,"GatewayId"=>$gatewayId,"GuiIdChanged"=>"false","IsSubBundle"=>"false","LastAccess"=>$lastAccess,"SystemId"=>$systemId,"ValueIdList"=>$valueIds);
