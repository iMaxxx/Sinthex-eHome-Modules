    ...
    class WolfSmartset extends IPSModule {
        ...
        */
		...
		public function GetValues() {
			...
			$post_parameters = (object) array("GuiId"=>"1200","GatewayId"=>$gatewayId,"GuiIdChanged"=>"true","IsSubBundle"=>"false","LastAccess"=>"2016-08-12T11:40:32.3956505Z","SystemId"=>$systemId,"ValueIdList"=>$valueIds);
